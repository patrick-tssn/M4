...
device = "cuda:0"
model = LongVA(pretrained="checkpoints/longva7b-qwen2-llavanext-vst-vt-st-300k/checkpoint-3500", model_name="llava_qwen", device_map=device, attn_implementation="eager")
visual_path = ""
question = ""
...
async def echo(websocket, path):
    ...
    async for message in websocket:
        ...
        ret_code = model.output(query, gen_kwargs)
