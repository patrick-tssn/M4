...
#SBATCH --gres=gpu:4
#SBATCH --output=./slurm_logs/finetune-longva-sub10k-ORNS-speech-cosyvoice.out
#SBATCH --error=./slurm_logs/finetune-longva-sub10k-ORNS-speech-cosyvoice.error.out
...
# LLM_VERSION="checkpoints/longva7b-qwen2-llavanext-speech/checkpoint-3000"
# LLM_VERSION="checkpoints/longva7b-qwen2-voiceassistant/checkpoint-11500"
LLM_VERSION="checkpoints/longva7b-qwen2-voiceassistant"
...
MID_RUN_NAME="longva7b-llavanextsub10k-qwen2-speech-cosyvoice"
...
# --data_path inputs/texts/llava-next-sub-10k-ORNS1111-speech-qwen-5.json \
...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${NUM_GPUS}" --master_port="${PORT}" \
    ...
    --data_path inputs/texts/llava_next-speech-100-orns.json \
...
# --model_max_length 32768 \ # 8192 \ 16384
