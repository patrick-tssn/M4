...
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
#SBATCH --output=./slurm_logs/dpo-longva-llama3.1.out
#SBATCH --error=./slurm_logs/dpo-longva-llama3.1.error.out
...
BASE_RUN_NAME="longva7b-llavanext-llama31"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"

MID_RUN_NAME="longva7b-llavanext-llama31-dpo"
