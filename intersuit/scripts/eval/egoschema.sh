...
#SBATCH --gres=gpu:1
#SBATCH --output=./slurm_logs/finetune-longva-sub-eval-egoschema.out
#SBATCH --error=./slurm_logs/finetune-longva-sub-eval-egoschema.error.out
...
video_dir="${Zero_Shot_QA}/egoschema/videos"
gt_file_question="${Zero_Shot_QA}/egoschema/test_q.json"
gt_file_answers="${Zero_Shot_QA}/egoschema/test_a.json"
output_dir="${Zero_Shot_QA}/egoschema/${MID_RUN_NAME}"
NUM_FRAMES=32
