...
#SBATCH --gres=gpu:4
#SBATCH --output=./slurm_logs/dpo-qwen2-7b-llava.out
#SBATCH --error=./slurm_logs/dpo-qwen2-7b-llava.error.out
...
BASE_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-finetune_llavanext_unfreezeclip"
