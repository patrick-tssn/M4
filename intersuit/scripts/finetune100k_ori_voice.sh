...
#SBATCH --gres=gpu:4
#SBATCH --output=./slurm_logs/finetune-longva-voice-100k-z1.out
#SBATCH --error=./slurm_logs/finetune-longva-voice-100k-z1.error.out
...
MID_RUN_NAME="longva7b-qwen2-voiceassistant-100k-orns"
