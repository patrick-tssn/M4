#!/bin/bash
#SBATCH --job-name=iovaspeechLVsub
...
#SBATCH --gres=gpu:4
#SBATCH --output=./slurm_logs/finetune-longva-voice-100k-orns.out
#SBATCH --error=./slurm_logs/finetune-longva-voice-100k-orns.error.out
...
LLM_VERSION="checkpoints/longva7b-llavanextsub10k-qwen2-ORNS1111"
...
MID_RUN_NAME="longva7b-qwen2-voiceassistant-100k-orns1111"
...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${NUM_GPUS}" --master_port="${PORT}" \
    ...
    --data_path inputs/texts/voiceassistant-100k.json \
