...
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
#SBATCH --output=./slurm_logs/finetune-longva-llavanext-speech-full.out
#SBATCH --error=./slurm_logs/finetune-longva-llavanext-speech-full.error.out
...
LLM_VERSION="checkpoints/longva7b-qwen2-voiceassistant/checkpoint-12000"
...
MID_RUN_NAME="longva7b-qwen2-llavanext-speech-full"
