...
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
#SBATCH --output=./slurm_logs/dpo-longva-qwen2.5.out
#SBATCH --error=./slurm_logs/dpo-longva-qwen2.5.error.out
...
BASE_RUN_NAME="longva7b-llavanext-qwen25"
